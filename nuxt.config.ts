    ...
    locales: [
      {
        ...
        name: "English",
        iso: "en-US",
        files: ["en.json", "en-incubation.json", "en-blog.json", "en-developers.json", "en-community.json", "en-ecosystem.json", "en-japan.json", "en-contact.json", "en-home.json"],
      },
      {
        code: "ja",
        name: "日本語",
        iso: "ja-JP",
        files: ["ja.json", "ja-incubation.json", "ja-blog.json", "ja-developers.json", "ja-community.json", "ja-ecosystem.json", "ja-japan.json", "ja-contact.json", "ja-home.json"],
      },
    ],
    langDir: "lang",
    defaultLocale: "en",
