export const mentors = [
  {
    ...
    profile: {
      ...
      ja: "これまでソニーグループ内で複数の新規事業の立ち上げに携わる。現在、Sony Network Communications事業開発部でWeb3/NFT事業を管轄。2022年4月に設立したWeb3/NFT事業を推進するSony Network Communications SingaporeのDirectorに就任。",
    },
    image: "suzuki.jpg",
    expertise: [],
    links: {
  ...
  },
  {
    ...
    title: {
      ...
      ja: "Astar Network ファウンダー, Startale Labs 最高経営責任者",
    },
    profile: {
      ...
      ja: "シリコンバレーでのインターンシップ、東京大学大学院ブロックチェーン共同研究員を経て、2019年Stake Technologiesを創業。日本発のパブリックブロックチェーンであるAstar Networkの創業者となる。Next Web Capitalファウンダー、日本ブロックチェーン協会（JBA）理事や、GMO Web3、電通Web3、や丸井グループのアドバイザー/顧問も務める。2022年、Forbes紙の選ぶテクノロジー部門 Forbes Asia 30 Under 30に選出。同年、Forbes Japan 30 Under 30にも選出された。2023年にはweb3開発会社であるStartale Labsを創業し、Astar Networkを活用したユースケースを作るために日本の大企業とコラボレーションして案件を進める。",
    },
    image: "sota.jpg",
    expertise: [
      { en: "Infrastructure", ja: "インフラ" },
      { en: "Product", ja: "プロダクト開発" },
    ],
    links: {
